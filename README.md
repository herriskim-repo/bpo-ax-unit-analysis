...
목표는 기존 Looker Studio 기반 단순 시각화 보고를 넘어, 운영 데이터를 기반으로 AI Executive Reporting 체계를 구축하는 것입니다.
...
- GitHub에는 코드와 문서만 저장
- 실제 데이터는 Google Workspace 또는 로컬 보안 저장소 내 관리
- 샘플 데이터는 익명화된 구조만 사용
...
개인 경험 → 운영 규칙 → AGENTS.md / Skills → 조직 지식
